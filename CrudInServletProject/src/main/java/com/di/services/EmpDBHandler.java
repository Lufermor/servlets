...
import java.sql.*;
/*
 * EmpDBHandler.java class handles the database connection to our MySQL server. 
 * It contains the necessary information for the connection.
 */
public class EmpDBHandler{
    ...
    public static Connection getConnection (){
        ...
        try{
            ...
            con =DriverManager.getConnection ("jdbc:mysql://localhost:3306/crud_servlet_db","root", "root");;
        } 
        catch (Exception e){
